...
type Source = "Official default" | "Community-common" | "QuickStackTool opinion";
...
export function renderDecisions(ctx: ProjectContext): string {
	...
	if (dirEntries.length > 0) {
		sections.push("", "## Directory Structure (QuickStackTool opinion)", "");
