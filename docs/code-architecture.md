...
| 4 | npm 패키지 이름 | **`quick-stack-tool`** (fallback: `quickstack-cli`) |
...
- npm 패키지명: `quick-stack-tool` (unscoped)
- `npx quick-stack-tool`로 실행
...
├──────────────┬───────────────────────────────────┤
│ Package      │ quick-stack-tool (bin: quickstack)  │
