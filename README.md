...
```bash
pnpm dlx quick-stack-tool         # pnpm (일회성 실행)
yarn dlx quick-stack-tool         # yarn (일회성 실행)
```

### 전역 설치 (반복 사용 시)

```bash
npm install -g quick-stack-tool   # npm
pnpm add -g quick-stack-tool      # pnpm
yarn global add quick-stack-tool  # yarn
